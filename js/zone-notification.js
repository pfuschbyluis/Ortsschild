(function () {
  ...
  /**
   * Zeigt eine GTA/FiveM-artige Zonen-Benachrichtigung oben mittig an.
   * @param {string} title - Haupttitel (z. B. „Innenstadt“)
   * @param {string} subtitle - Untertitel (z. B. Geschwindigkeitshinweis)
   * @param {number} [durationMs=5000] - Anzeigedauer in Millisekunden
   */
